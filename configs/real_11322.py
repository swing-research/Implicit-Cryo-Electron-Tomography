...
def get_config():
    ...
    config.multires_params.startResolution = 3
    config.multires_params.ray_change_epoch = [50, 100, 400]
    ...
    # Sampling operator
    config.view_angle_min = -60 # -60
    config.view_angle_max = 60 #60
    ...
    config.volume_name = '20200305_riboprot_singleshot_a010_tomo_001_bin8'
    config.angle_name = ''
    config.path_load = "/local/Tomograms_cryoET/real_data_aligned/11322"
    config.name_best_proj = '20200305_riboprot_singleshot_a010_tomo_001.mrc'
    config.path_save_data = "./results/11322/"
    config.path_save = "./results/11322/"
    ...
    config.nRays = 800
    config.ray_length = 256  #int(np.floor(n1*z_max))
    ...
    config.wd = 5*1e-6 # weights decay
    config.clip = 0
