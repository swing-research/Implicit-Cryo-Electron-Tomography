...
def get_default_realData_10364():
    config = ml_collections.ConfigDict()
    # simulation
    # config = simulation = ml_collections.ConfigDict()

    config.volume_name = 'empiar-10364'
    config.volume_file = None
    ...
    config.transpose = False # if the axis of the projections are horizontal
    config.fixed_angle = 0 # in degrees
  ...
  # training
    ...
    ## Parameters
    config.epochs = 5000
    config.Ntest = 200 # number of epoch before display
